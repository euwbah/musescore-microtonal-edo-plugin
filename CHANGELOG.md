...
- Removed unnecessary GUI dialog --- planning to make a 31-TET suite of micro-plugin features which
...
- Fixed occasional bug where microtonal accidentals carry over the bar line when it shouldn't
